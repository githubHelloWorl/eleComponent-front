            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="name">
                        <Input type="text" v-model="searchForm.name" placeholder="供应商名称" clearable style="width: 120px" />
                    </Form-item>
                    <Form-item label="" prop="type">
                        <Select v-model="searchForm.type" placeholder="供应商类型" clearable style="width: 120px">
                    ...
                    <Form-item label="" prop="address">
                        <Input type="text" v-model="searchForm.address" placeholder="供应商地址" clearable style="width: 120px" />
                    </Form-item>
