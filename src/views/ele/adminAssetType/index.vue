            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="type">
                        <dict dict="adminAssetType" v-model="searchForm.type" transfer style="width: 150px" placeholder="元器件大类..." />
                    </Form-item>
                    <Form-item label="" prop="title">
                        <Input type="text" v-model="searchForm.title" placeholder="分类名称..." clearable style="width: 150px" />
                    </Form-item>
...
<script>
import {
    getAdminAssetTypeList,
    deleteAdminAssetType
} from "./api.js";
...
export default {
    ...
    methods: {
        ...
        getDataList() {
            this.loading = true;
            getAdminAssetTypeList(this.searchForm).then(res => {
                this.loading = false;
                if (res.success) {
