...
<div class="search">
    ...
    <Card v-show="currView=='index'">
            ...
            <Form ref="searchForm" :model="searchForm" inline :label-width="0">
                <Form-item ref="searchForm" :model="searchForm" inline :label-width="0" style="display:flex;">
                    <Form-item label="" prop="name">
                        <Input type="text" v-model="searchForm.name" placeholder="仓库名称" clearable style="width: 120px" />
                    </Form-item>
                    <Form-item label="" prop="address">
                        <Input type="text" v-model="searchForm.address" placeholder="仓库地址" clearable style="width: 120px" />
                    </Form-item>
                    <Form-item label="" prop="adminName">
                        <Input type="text" v-model="searchForm.adminName" placeholder="仓管员" clearable style="width: 120px" />
                    </Form-item>
        ...
        <Row type="flex" justify="end" class="page">
            <Page :current="searchForm.pageNumber" :total="total" :page-size="searchForm.pageSize" @on-change="changePage" @on-page-size-change="changePageSize" :page-size-opts="[15,20,50,200]" size="small" show-total show-elevator show-sizer></Page>
        </Row>
    </Card>
</div>
</template>
        ...
        return {
            ...
            columns: [
                ...
                },
                {
                    ...
                    sortable: false,
                    render: (h, params) => {
                        if (params.row.attributionType == 1) {
                            return h("div", [
                                h(
                                    "span", {
                                        style: {
                            ...
                            return h("div", [
                                h(
                                    ...
                                    params.row.adminName + " (" + params.row.jobNumber + ")"
                                ),
                            ]);
                        }
                    },
