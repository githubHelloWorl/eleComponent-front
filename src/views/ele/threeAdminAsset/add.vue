    ...
    <Card>
        ...
        <Form ref="form" :model="form" :label-width="100" :rules="formValidate" label-position="left">
            ...
            <Row type="flex" justify="center">
                <Form-item class="br">
                    <Button @click="handleSubmit" :loading="submitLoading" type="success">确认新增</Button>
...
export default {
    ...
    methods: {
        ...
        handleSubmit() {
            var that = this;
            if (this.cascaderValue == undefined || this.cascaderValue.length < 2) {
                this.$Message.warning("请选择元器件分类！");
            } else {
                that.submitLoading = true;
                that.form.type2 = this.cascaderValue[0];
                that.form.type = this.cascaderValue[1];
